...
<main class="container mx-auto px-4 mt-[120px] pb-16">
    <div class="max-w-7xl mx-auto">
        <div class="mb-12 text-center">
            <h1 class="text-3xl md:text-5xl font-medium text-slate-800 leading-tight mb-4"><?php post_type_archive_title(); ?></h1>
            <p class="text-slate-600 text-lg">بررسی و جستجوی تمامی آگهی‌های ثبت شده</p>
        </div>
