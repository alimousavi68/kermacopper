...
<main>
    ...
    <header class="relative min-h-[520px] flex items-center justify-center overflow-hidden bg-navy-dark pt-32 lg:pt-40 pb-16">
        ...
        <div class="absolute inset-0 w-full h-full">
            <img src="<?php echo get_template_directory_uri(); ?>/images/pano sarcheshmeh.jpg"
                class="hero-bg-image w-full h-full object-cover opacity-35 mix-blend-overlay will-change-transform"
                alt="درباره مس کرمان زمین">
            ...
            <!-- Glow Accent -->
            <div class="absolute -top-[20%] left-1/2 -translate-x-1/2 w-[70%] h-[70%] bg-copper/20 rounded-full blur-[140px] z-15"></div>
        </div>
    ...
    <!-- MAIN CONTENT -->
    <div id="content" class="relative z-20 pb-36 bg-gradient-to-b from-[#FAF8F5] via-white to-[#FAF8F5] pt-8 lg:pt-12">

        <!-- Traditional Kerman Shamseh Watermark -->
        <div class="absolute left-[-100px] top-[15%] w-[500px] h-[500px] opacity-[0.025] text-navy pointer-events-none z-0 select-none">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" fill="none" stroke="currentColor" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round" class="w-full h-full">
                <circle cx="100" cy="100" r="15" /><circle cx="100" cy="100" r="8" />
                <path d="M 100 65 C 92 80, 108 80, 100 65 Z" /><path d="M 100 135 C 92 120, 108 120, 100 135 Z" />
                <path d="M 65 100 C 80 92, 80 108, 65 100 Z" /><path d="M 135 100 C 120 92, 120 108, 135 100 Z" />
                <polygon points="100,45 139,61 155,100 139,139 100,155 61,139 45,100 61,61" stroke-dasharray="4,4" />
                <path d="M 100 45 Q 110 25 100 10 Q 90 25 100 45" /><path d="M 100 155 Q 110 175 100 190 Q 90 175 100 155" />
                <path d="M 155 100 Q 175 110 190 100 Q 175 90 155 100" /><path d="M 45 100 Q 25 110 10 100 Q 25 90 45 100" />
            </svg>
        </div>
        ...
        <div class="container mx-auto px-6 lg:px-12 relative z-10">
            ...
            <section class="mb-32">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                    ...
                    <div class="md:col-span-2 bg-white border border-copper/12 rounded-[2.5rem] p-8 sm:p-10 flex flex-col justify-between relative overflow-hidden transition-all duration-500 hover:border-copper/30 hover:shadow-[0_25px_50px_-12px_rgba(200,104,47,0.08)] hover:-translate-y-1 scroll-reveal">
                        <div class="relative z-10">
                            <div class="w-12 h-12 rounded-2xl bg-copper/10 text-copper flex items-center justify-center mb-6">
                                <?php echo kermancopper_icon('history', 'w-6 h-6'); ?>
                            </div>
                        ...
                        <!-- Watermark -->
                        <div class="absolute bottom-[-50px] left-[-50px] w-52 h-52 opacity-[0.04] pointer-events-none text-copper">
                            <?php echo kermancopper_icon('award', 'w-full h-full'); ?>
                        </div>
                    </div>

                    <!-- Card 2: Discovery -->
                    <div class="bg-white border border-copper/12 rounded-[2.5rem] p-8 flex flex-col justify-between transition-all duration-500 hover:border-copper/30 hover:shadow-[0_25px_50px_-12px_rgba(200,104,47,0.08)] hover:-translate-y-1 scroll-reveal">
                        <div>
                            <div class="w-12 h-12 rounded-2xl bg-copper/10 text-copper flex items-center justify-center mb-6">
                                <?php echo kermancopper_icon('search', 'w-6 h-6'); ?>
                            </div>
                    ...
                    <!-- Card 4: Environment (2 cols wide) -->
                    <div class="md:col-span-2 bg-white border border-copper/12 rounded-[2.5rem] p-8 sm:p-10 flex flex-col justify-between relative overflow-hidden transition-all duration-500 hover:border-copper/30 hover:shadow-[0_25px_50px_-12px_rgba(200,104,47,0.08)] hover:-translate-y-1 scroll-reveal">
                        <div class="relative z-10">
                            <div class="w-12 h-12 rounded-2xl bg-copper/10 text-copper flex items-center justify-center mb-6">
                                <?php echo kermancopper_icon('leaf', 'w-6 h-6'); ?>
                            </div>
                ...
                <div class="space-y-16">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center scroll-reveal">
                        <div class="lg:col-span-6 relative rounded-[2rem] overflow-hidden shadow-[0_15px_45px_rgba(0,0,0,0.03)] border border-slate-200/60 bg-white">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/about/realistic_mine.png" alt="معدن‌کاری و استخراج مس" class="w-full h-[320px] object-cover hover:scale-105 transition-transform duration-700">
                            <div class="absolute top-6 right-6 bg-navy/95 backdrop-blur text-white text-xs font-black px-4 py-2 rounded-xl border border-white/10 font-peyda">گام نخست: استخراج</div>
                        </div>
                        <div class="lg:col-span-6 font-peyda">
                            ...
                            <p class="text-slate-600 text-sm md:text-base leading-relaxed font-semibold">
                                استخراج مواد معدنی کانسار پورفیری سرچشمه با روش استخراج روباز (Open-Pit Mining) در پله‌هایی با ارتفاع مناسب صورت می‌پذیرد. عملیات چال‌زنی، آتش‌باری سنگ‌های سخت و ترابری با غول‌پیکرترین کامیون‌های معدنی سنگ شکن‌ها را به کار می‌اندازد. نظارت مانیتورینگ آنلاین دیسپچینگ، ضامن امنیت و راندمان این فرآیند شبانه‌روزی است.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center scroll-reveal">
                        <div class="lg:col-span-6 lg:order-2 relative rounded-[2rem] overflow-hidden shadow-[0_15px_45px_rgba(0,0,0,0.03)] border border-slate-200/60 bg-white">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/about/image1.png" alt="تغلیظ مس" class="w-full h-[320px] object-cover hover:scale-105 transition-transform duration-700">
                            <div class="absolute top-6 right-6 bg-navy/95 backdrop-blur text-white text-xs font-black px-4 py-2 rounded-xl border border-white/10 font-peyda">گام دوم: فرآوری و تغلیظ</div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center scroll-reveal">
                        <div class="lg:col-span-6 relative rounded-[2rem] overflow-hidden shadow-[0_15px_45px_rgba(0,0,0,0.03)] border border-slate-200/60 bg-white">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/about/realistic_foundry.png" alt="ذوب مس" class="w-full h-[320px] object-cover hover:scale-105 transition-transform duration-700">
                            <div class="absolute top-6 right-6 bg-navy/95 backdrop-blur text-white text-xs font-black px-4 py-2 rounded-xl border border-white/10 font-peyda">گام سوم: ذوب و ریخته‌گری</div>
                        </div>
                        <div class="lg:col-span-6 font-peyda">
                            <h3 class="text-2xl lg:text-3xl font-black text-navy mb-4 flex items-center gap-3">
                            ...
                            <p class="text-slate-600 text-sm md:text-base leading-relaxed font-semibold">
                                کنسانتره مس تغلیظ شده در کوره‌های پیشرفته شعله‌ای و فلش حرارت داده شده تا ناخالصی‌ها در قالب سرباره تخلیه و مس مات با عیار بالای ۶۰ درصد حاصل شود. در مرحله بعد مس تاول‌زا تولید شده و سرانجام مس آندی با خلوص ۹۹.۳ درصد برای ریخته‌گری در چرخ آند ریخته می‌شود.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center scroll-reveal">
                        <div class="lg:col-span-6 lg:order-2 relative rounded-[2rem] overflow-hidden shadow-[0_15px_45px_rgba(0,0,0,0.03)] border border-slate-200/60 bg-white">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/about/mes-premium.png" alt="کاتد مس پالایش شده" class="w-full h-[320px] object-cover hover:scale-105 transition-transform duration-700">
                            <div class="absolute top-6 right-6 bg-navy/95 backdrop-blur text-white text-xs font-black px-4 py-2 rounded-xl border border-white/10 font-peyda">گام چهارم: الکترولیز و کاتد</div>
                        </div>
                        <div class="lg:col-span-6 lg:order-1 font-peyda">
                            <h3 class="text-2xl lg:text-3xl font-black text-navy mb-4 flex items-center gap-3">
            ...
            <section class="bg-navy rounded-[3rem] p-8 sm:p-12 lg:p-16 text-white relative overflow-hidden scroll-reveal">
                ...
                <div class="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div class="lg:col-span-5 font-peyda">
                        ...
                        <p class="text-slate-400 text-sm md:text-base leading-relaxed font-light mb-8">
                        ...
                        <div class="flex gap-4 flex-wrap">
                            <a href="<?php echo esc_url( home_url( '/contact' ) ); ?>" class="bg-copper hover:bg-copper-light text-white px-6 py-3 rounded-full text-sm font-bold transition-all shadow-[0_10px_25px_rgba(200,104,47,0.3)] hover:-translate-y-1">تماس مستقیم با ما</a>
                            <a href="<?php echo esc_url( home_url( '/#news' ) ); ?>" class="border border-white/20 hover:bg-white hover:text-navy text-white px-6 py-3 rounded-full text-sm font-bold transition-all hover:-translate-y-1">اخبار و رویدادها</a>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <!-- Value 1 -->
                        <div class="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur hover:bg-white/10 hover:border-copper/30 transition-all duration-300">
